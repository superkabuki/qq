...
class Signal:
    ...
    def decode(self, bites):
        """
        decode base decode called with super() in subclasses,.
        """
    ...
    def encode(self):
        """
        encode base encode called with super() in subclasses
        """
        qq = b"qque"
...
class SpliceSignal(Signal):
    ...
    def decode(self, bites):
        """
        decode decode for SpliceSignal
        """
        super().decode(bites)
    ...
    def unroll_descriptors(self, bites):
        ...
        while idx < bytelen:
            ...
            idx += dlength
            descriptor = self.descriptor_map[dtype](dbytes)
            descriptor.decode()
            self.descriptors.append(descriptor)

    def roll_descriptors(self):
        """
        roll_descriptors turn descriptors into bytes for encoding
        """
    ...
    def encode(self):
        """
        encode encode method for SpliceSignal
        """
        qqbase = super().encode()
